...
Webflow.require('ix').init([
  ...
  {"slug":"show-on-click","name":"show on click","value":{"style":{},"triggers":[{"type":"click","selector":".sign-up-to-use-this-feature","stepsA":[{"display":"block"}],"stepsB":[]}]}},
  {"slug":"hide-message-on-load","name":"hide message on load","value":{"style":{"display":"none"},"triggers":[]}},
  {"slug":"show-message-on-click","name":"show message on click","value":{"style":{},"triggers":[{"type":"click","selector":".temporarily-offline","stepsA":[{"display":"block"}],"stepsB":[]}]}}
]);
