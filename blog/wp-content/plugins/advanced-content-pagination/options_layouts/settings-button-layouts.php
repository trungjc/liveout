<tr class="type-post status-publish format-standard hentry category-uncategorized alternate iedit author-self level-0">
    <th colspan="4" scope="col"><h2><?php _e('Pagination Button Layout','ac_paging');?></h2></th>
</tr>

<tr>
    <th scope="row">
	<?php _e('Display Only Previous and Next Buttons','ac_paging');?>:
    <p style="font-size:13px; color:#666666; margin:0px; "><?php _e('This option is only related to the first and second layouts. Allows to only show the previous and next titles in subPage buttons.','ac_paging');?></p>
    </th>
    <td colspan="3">
...
<tr class="paging_btn_layout type-post status-publish format-standard hentry category-uncategorized alternate iedit author-self level-0" valign="top">
    <th scope="row"><?php _e('Pagination Button Style','ac_paging');?>:</th>
    <td colspan="3">
        <fieldset>
            <?php
            ...
            <label title="Title">
                ...
                <span>
                    <img src="<?php echo plugins_url('advanced-content-pagination/files/img/t_button.png'); ?>" align="absmiddle" style="padding:3px 5px;"  />
                </span>
            </label><br>
            <label title="Title and Number">
                ...
                <span>
                    <img src="<?php echo plugins_url('advanced-content-pagination/files/img/nt_button.png'); ?>" align="absmiddle" style="padding:3px 5px;" />
                </span>
            </label><br>
            <label title="Next and Prev">
                ...
                <span>
                    <img src="<?php echo plugins_url('advanced-content-pagination/files/img/pn_button.png'); ?>" align="absmiddle" style="padding:3px 5px;"  />
                </span>
            </label><br>
        </fieldset>
    </td>
